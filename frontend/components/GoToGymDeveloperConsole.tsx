...
export const GoToGymDeveloperConsole: React.FC = () => {
  ...
  return (
    <div className="gtg-dashboard">
      <div className="gtg-container">
        <header>
          <h1>GoToGym Developer Console</h1>
          <p>Tu espacio para integrar, monitorear y probar datos biométricos de múltiples fuentes.</p>
        </header>
        ...
        <section className="gtg-result-panel">
          ...
          {uiState === 'success' && bodyGraph && (
            <pre className="gtg-json-block">{JSON.stringify(bodyGraph, null, 2)}</pre>
          )}
        </section>
      </div>
    </div>
