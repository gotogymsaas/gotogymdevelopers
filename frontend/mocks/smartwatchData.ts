...
export const smartwatchHeartRateTrendMock: HeartRateTrendPoint[] = [
  { time: '06:00', bpm: 68 },
  { time: '08:00', bpm: 74 },
  { time: '10:00', bpm: 79 },
  { time: '12:00', bpm: 83 },
...
export const smartwatchActivitySummaryMock: ActivitySummaryDatum[] = [
  { metric: 'Pasos', value: 8450, unit: 'pasos', color: '#10b981' },
  { metric: 'Calorias', value: 510, unit: 'kcal', color: '#f59e0b' },
  { metric: 'Distancia', value: 6.8, unit: 'km', color: '#6366f1' },
];
